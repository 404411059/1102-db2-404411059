...
create table public.shop_59 (
        ...
        cat_id integer,
        constraint cat_id_fkey foreign key (cat_id) references category_59 (id),
...
-- the primary key `id` is auto-generated by schema.
-- schema: (cat_id, product_name, price, remote_url, local_url)
copy shop_59 (cat_id, product_name, price, remote_url, local_url) from stdin with (format csv);
